        ...
        <div class="container mx-auto max-w-sm w-full p-4 sm:w-1/2">
            <div class="card flex flex-col justify-center p-10 bg-white rounded-lg shadow-2xl">
                <div class="prod-title">
                    ...
                    <p class="text-lg uppercase text-gray-900 font-bold">{ city }</p>
                </div>
                <div class="prod-img">
                    <img src="https://lh3.googleusercontent.com/p/AF1QipMBd6QwwirgaIbwTN76uMBo53xhwuyoYBxXEjkJ=s680-w680-h510"
                        class="w-auto h-auto object-cover object-center pb-3" />
                </div>
                <div class="prod-info grid gap-10">
                    <div class="text-sm leading-normal mt-0 mb-2 text-blueGray-400 font-bold uppercase">
                        <svg class=" absolute mr-2 text-lg text-blueGray-400 h-4 w-4" xmlns="http://www.w3.org/2000/svg" fill="currentColor"  viewBox="0 0 16 16">
